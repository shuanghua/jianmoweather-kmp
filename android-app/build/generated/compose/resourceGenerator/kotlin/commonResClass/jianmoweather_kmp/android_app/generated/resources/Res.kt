...
package jianmoweather_kmp.android_app.generated.resources
...
internal object Res {
  ...
  public suspend fun readBytes(path: String): ByteArray =
      readResourceBytes("composeResources/jianmoweather_kmp.android_app.generated.resources/" +
      path)
  ...
  public fun getUri(path: String): String =
      getResourceUri("composeResources/jianmoweather_kmp.android_app.generated.resources/" + path)

...
internal object Res {
  ...
  public suspend fun readBytes(path: String): ByteArray =
      readResourceBytes("composeResources/jianmoweather_kmp.data.compose_res.generated.resources/" +
      path)
  ...
  public fun getUri(path: String): String =
      getResourceUri("composeResources/jianmoweather_kmp.data.compose_res.generated.resources/" +
      path)
